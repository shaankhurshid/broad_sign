...
ggsave(filename='/Volumes/medpop_afib/skhurshid/PRS/charge_dist.pdf',height=2,width=3,
       scale=4,device='pdf')
...
ggplot() + geom_density(data=data,aes(x=value,fill=L1),alpha=0.55,bw='nrd0',adjust=1.4) +
  ...
  theme(panel.background=element_blank(),axis.line=element_line(color='black'),legend.position=c(0.20,0.90),
        ...
        axis.title.x = element_text(size=20),legend.text=element_text(size=20)) +
  labs(x='CHARGE-AF Score',y='density')
ggsave(filename='/Volumes/medpop_afib/skhurshid/PRS/charge_rw_dist.pdf',height=2,width=3,
       scale=4,device='pdf')
...
ggplot() + geom_density(data=data,aes(x=value,fill=L1),alpha=0.55,bw='nrd0',adjust=1.4) +
  ...
  theme(panel.background=element_blank(),axis.line=element_line(color='black'),legend.position=c(0.20,0.90),
        ...
        axis.title.y = element_text(size=20,margin = margin(t = 0, r = 10, b = 0, l = 0)),
        axis.title.x = element_text(size=20),legend.text=element_text(size=20)) +
  labs(x='Modified CHARGE-AF Score',y='density')
ggsave(filename='/Volumes/medpop_afib/skhurshid/PRS/sign_dist.pdf',height=2,width=3,
       scale=4,device='pdf')
...
ggplot() + geom_density(data=data,aes(x=value,fill=L1),alpha=0.55,bw='nrd0',adjust=1.4) +
  ...
  theme(panel.background=element_blank(),axis.line=element_line(color='black'),legend.position=c(0.80,0.90),
        ...
        axis.title.x = element_text(size=20),legend.text=element_text(size=20)) +
  labs(x='Predicted AF risk (CHARGE-AF, %)',y='density')
ggsave(filename='/Volumes/medpop_afib/skhurshid/PRS/density_charge_rw_pred.pdf',height=2,width=3,
       scale=4,device='pdf')
...
ggplot() + geom_density(data=data,aes(x=value,fill=L1),alpha=0.55,bw='nrd0',adjust=1.4) +
  ...
  theme(panel.background=element_blank(),axis.line=element_line(color='black'),legend.position=c(0.80,0.90),
        ...
        axis.title.y = element_text(size=20,margin = margin(t = 0, r = 10, b = 0, l = 0)),
        axis.title.x = element_text(size=20),legend.text=element_text(size=20)) +
  labs(x='Predicted AF risk (Modified CHARGE-AF, %)',y='density')
ggsave(filename='/Volumes/medpop_afib/skhurshid/PRS/density_sign_rw_pred.pdf',height=2,width=3,
       scale=4,device='pdf')
